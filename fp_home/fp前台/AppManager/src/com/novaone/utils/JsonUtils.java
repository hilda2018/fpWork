...
public class JsonUtils {
    ...
    public static <T> String toJson(T obj) {
        Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").enableComplexMapKeySerialization()
    ...
    public static <T> String toJson(T obj, String dateFormatter) {
        Gson gson = new GsonBuilder().setDateFormat(dateFormatter).enableComplexMapKeySerialization()
                .disableHtmlEscaping().create();
        return gson.toJson(obj);
    }
