...
//		exportExcel(sheetName, null,null, dataset, out, "yyyy-MM-dd");
//	}

//	public void exportExcel(String sheetName,String[] headers, Collection<T> dataset,
//			OutputStream out) {
//		exportExcel(sheetName, headers,null, dataset, out, "yyyy-MM-dd");
//	}
	/**
	 * 
	 * @param title
	 ...
	 *            如果有时间数据，设定输出格式。默认为"yyy-MM-dd"
	 */
	public void exportExcel(String title, String[] headers,int[] columnWidths,
		...
		//设置表格宽度
		//int[] columnWidths ={5500,3000,5300,2500,2500,6000,2500,2500,6000,3500,2500,2500,2500,3000,2500,3000,2500,3000,2500};
