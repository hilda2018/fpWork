...
<style>
		...
		.navbar{width:400px;float:right;height:100%;}
					 ...
					 <c:choose>
				        ...
				        <div class="fr name" id="LoginA" style="display: block;">
					        	<a href="" id="usernameInfo"></a>  
								 <p id="info">
								  <a href="javascript:void(0);" onclick="clearUser();" id="out">退出登录&nbsp;&nbsp;</a> | <a id="enterFP" href="${foreignprocurementPath }/jump!page.dhtml?p=login_page" >&nbsp;&nbsp;进入生鲜港</a> 
								</p>				        
						</div>
