...
<html>
  <head>
	...
	<script type="text/javascript" src="${applicationScope.sysConfigs['sysPath']}/style/style-module/service/serviceList.js"></script>
  ...
  <body>
		...
		<div class="wrapper">
			<div class="buyer-list">
				<div class="map">
					<a href="${applicationScope.sysConfigs['sysPath']}/pages/index/index.jsp">Home</a> > <a href="">Services</a> 
				...
				<table  id="serviceList">
					<thead>
						...
						<td class="t3">Company Type</td>
						<td class="t4">Company Start From</td>
					</thead>
				</table>
