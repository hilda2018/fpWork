...
function generateRequireData(data ,id,customData){
	...
	for(var i = 0;i<data.length;i++){
		str+='<li><div class="first"><i><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg_supplier"></use></svg></i><div class="bubble"><span class="bubbleTriangle"></span><p class="infoPeople"><em> '+data[i].name+'</em><strong>'+data[i].time+'</strong></p><p>'+data[i].detail+'</p></div></div></li>';
	}
	$box.html(str);
