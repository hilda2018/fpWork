(function (c) {
    var b = "rollIn fadeIn fadeInUp fadeInDown fadeInLeft fadeInRight fadeInRight bounceIn bounceInDown bounceInUp bounceInLeft bounceInRight rotateInDownLeft rotateInDownRight rotateInUpLeft rotateInUpRight".split(" "), d = b.length;
    c.fn.oneByOne = function (a) {
        function e(a) {
            g.slideShow && f();
            l.stop(!0, !0).animate({left: -a * j}, g.delay, function () {
                a != t && (r = t, q[r] && (!c.browser.msie && !c.browser.opera && q[r].fadeOut(), c(".buttonArea a:eq(" + r + ")", n).removeClass("active")), c(".buttonArea a:eq(" + a + ")", n).addClass("active"),
                    "random" != g.easeType.toLowerCase() ? q[a].show().children().each(function (a) {
        ...
        a && c.extend(g, a);
        var n, l, t = -1, j =
            g.width, s = 0, i = !1, w = [], v, q = [], m = 0, r = 0, o, p;
        l = this;
        ...
        g.enableDrag && (l.mousedown(function (a) {
            ...
            i && (s = a.pageX - this.mouseX, l.css("left", -t * j + s),
            g.slideShow && f());
            return !1
        }), l.mouseup(function () {
            i = !1;
            var a = t;
            if (!s)return !1;
            var b = parseInt(g.width), c = b / 2;
            -s > c - b * g.tolerance ? (a++, a = a >= m ? m - 1 : a, e(a)) : s > c - b * g.tolerance ? (a--, e(0 > a ? 0 : a)) : (e(a), g.slideShow && h());
            s = 0;
            return !1
        ...
        if (g.showButton) {
            ...
            c(".buttonCon a", a).bind("click", function () {
                if (c(this).hasClass("active"))return false;
                var a = c(this).attr("rel");
                e(a)
            })
        }
        g.showArrow && (p = c('<div class="arrowButton"><div class="prevArrow"></div><div class="nextArrow"></div></div>'), n.append(p), c(".nextArrow", p).bind("click", function () {
            k()
        }), c(".prevArrow", p).bind("click", function () {
            var a = t;
            a--;
            a = a < 0 ? m - 1 : a;
            e(a)
