...
jQuery.validator.addMethod("chinese", function(value, element) {
	return this.optional(element) || /(\d|[\u4e00-\u9fa5])*[\u4e00-\u9fa5]+(\d|[\u4e00-\u9fa5])*/.test(value);
}, "请输入中文");
...
jQuery.validator.addMethod("russian", function(value, element) {
	return this.optional(element)
			|| /(?:\xC0-\xFF|\xA3\xB3|\xA8\xB8)+/.test(value);
}, "请输入俄文");

jQuery.validator.addMethod("alphaAndNumeric", function(value, element) {
...
jQuery.validator.addMethod("positive", function(value, element) {
	return this.optional(element) || /^\+?[1-9][0-9]*$/.test(value) || /^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$/.test(value);
	}, "请输入正数");
...
jQuery.validator.addMethod("alphaNumericAndUnderLine1", function(value, element) {
...
jQuery.validator.addMethod("phone2", function(value, element) {
	return this.optional(element) || /^(((1[0-9]{1})|(1[0-9]{1}))+\d{9})$/.test(value);
}, "手机号码格式如：18900001122");
...
jQuery.validator.addMethod("chineseEnglish", function(value, element) {
	...
	return this.optional(element) || /^\s*[\u4e00-\u9fa5]{1,}[\u4e00-\u9fa5.·]{0,15}[\u4e00-\u9fa5]{1,}\s*$/.test(value);
}, "请输入正确的真实姓名");

jQuery.validator.addMethod("isZipCode", function(value, element) {
    return this.optional(element) || /^[0-9]{6}$/.test(value); }, "请正确填写您的邮政编码");
/**
